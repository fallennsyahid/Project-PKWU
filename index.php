...
<body>
    ...
    <div class="container py-2">
      <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
        ...
        <div class="col-sm-4 col-lg-3 text-center text-sm-start">
          <div class="main-logo">
            <a href="index.html">
              <img src="images/caseths-logo.png" alt="logo" class="img-fluid" width="100px">
            </a>
          </div>
        </div>
      ...
      <div class="swiper main-swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              ...
              <div class="content-wrapper col-md-7 p-5 mb-5">
                ...
                <h2 class="banner-title display-1 fw-normal">Best destination for <span class="text-primary">your accesories</span>
                </h2>
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              <div class="img-wrapper col-md-5">
                <img src="images/2-bg.png" class="img-fluid">
              </div>
              <div class="content-wrapper col-md-7 p-5 mb-5">
                <div class="secondary-font text-primary text-uppercase mb-4">Save 10 - 20 % off</div>
                <h2 class="banner-title display-1 fw-normal">Best destination for <span class="text-primary">your accesories</span>
          ...
          <div class="swiper-slide py-5">
            <div class="row banner-content align-items-center">
              <div class="img-wrapper col-md-5">
                <img src="images/3-bg.png" class="img-fluid">
              </div>
              <div class="content-wrapper col-md-7 p-5 mb-5">
                <div class="secondary-font text-primary text-uppercase mb-4">Save 10 - 20 % off</div>
                <h2 class="banner-title display-1 fw-normal">Best destination for <span class="text-primary">your accesories</span>
  ...
  <section id="clothing" class="my-5 overflow-hidden">
    <div class="container pb-5">
      ...
      <div class="section-header d-md-flex justify-content-between align-items-center mb-3">
        <h2 class="display-3 fw-normal">Flower Bucket</h2>
        <div>
          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">
            shop now
            <svg width="24" height="24" viewBox="0 0 24 24" class="mb-1">
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="images/<?php echo $row['picture'];?>" class="img-fluid rounded-4" alt="image"></a>
  ...
  <section id="foodies" class="my-5">
    <div class="container my-5 py-5">
      ...
      <div class="section-header d-md-flex justify-content-between align-items-center">
        <h2 class="display-3 fw-normal">Accsesories</h2>
      ...
      <!-- 1 -->
        <div class="item cat col-md-4 col-lg-3 my-4">
          <div class="card position-relative">
            <a href="single-product.html"><img src="images/1.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0"><?php echo $row['name'];?></h3>
              </a>
  ...
  <section id="latest-blog" class="my-5">
    <div class="container py-5 my-5">
      <div class="row mt-5">
        <div class="section-header d-md-flex justify-content-between align-items-center mb-3">
          <h2 class="display-3 fw-normal">Testimoni Pembeli</h2>
          <div>
            <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">
              Read all
              <svg width="24" height="24" viewBox="0 0 24 24" class="mb-1">
  ...
  <section id="insta" class="my-5">
    <div class="row g-0 py-5">
      ...
      <div class="col instagram-item  text-center position-relative">
        ...
        <a href="#">
          <img src="images/<?php echo $picture;?>" alt="insta-img" class="img-fluid rounded-3" width="400px">
        </a>
      </div>
      <?php
      // }
